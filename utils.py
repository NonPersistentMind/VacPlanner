...
vaccine_shorts = {vaccine.split(' – ')[0]: vaccine.split(' – ')[1] for vaccine in [
    ...
    'Інактивована вакцина для профілактики поліомієліту (ІПВ) – ІПВ',
    'Вакцина для профілактики туберкульозу – БЦЖ',
    'Вакцина для профілактики туберкульозу (БЦЖ) – БЦЖ',
    'Вакцина для профілактики кашлюку, дифтерії та правця з цільноклітинним кашлюковим компонентом – АКДП',
    'Комбінована вакцина для профілактики дифтерії, правця, кашлюка з цільноклітинним кашлюковим компонентом (АКДП) – АКДП',
    ...
    # 'Комбінована вакцина для профілактики дифтерії, правця, кашлюку (ацелюлярний компонент), гемофільної інфекції та гепатиту B (АаКДП+НІВ+ГепВ) – ДПКГП+ГепВ',
    'Вакцина для профілактики сказу – Сказ',
    'Вакцина проти сказу – Сказ', 
    'Вакцина для профілактики кашлюку,дифтерії та правця з цільноклітинним кашлюковим компонентом – АКДП',
]}
